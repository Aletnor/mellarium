...
(function () {
    ...
    function rpgInjectStyle() {
        ...
        const css = [
            ...
            '#mp_rpg_mask{position:fixed;inset:0;z-index:10000;background:rgba(0,0,0,.45);display:flex;align-items:center;justify-content:center;padding:16px}',
            '#mp_rpg_card{width:min(420px,94vw);max-height:82vh;overflow-y:auto;border-radius:20px;padding:18px 16px 14px;',
